...
* Edit local README.md file and update all links (just replace all occurrences of `'alexey-1991'` with your account name).
...
```
* Open https://github.com/alexey-1991/js-assignments and test the build icon. Now it will run all tests and update status once you push changes to github. Keep this icon green!
...
* Push your updates to github server and check if tests passed on [travis-ci](https://travis-ci.org/alexey-1991/js-assignments/builds).
